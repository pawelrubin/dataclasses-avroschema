...
CASE_TO_DATA_NESTED = [
    (
        case.CAMELCASE,
        '{"type": "record", "name": "Event", "fields": [{"name": "eventId", "type": "string"}, {"name": "user", "type": {"type": "record", "name": "user_record", "fields": [{"name": "name", "type": "string"}]}}]}',
    ),
    (
        case.CAPITALCASE,
        '{"type": "record", "name": "Event", "fields": [{"name": "Event_id", "type": "string"}, {"name": "User", "type": {"type": "record", "name": "user_record", "fields": [{"name": "Name", "type": "string"}]}}]}',
    ),
    (
        case.CONSTCASE,
        '{"type": "record", "name": "Event", "fields": [{"name": "EVENT_ID", "type": "string"}, {"name": "USER", "type": {"type": "record", "name": "user_record", "fields": [{"name": "NAME", "type": "string"}]}}]}',
    ...
    (
        case.PATHCASE,
        '{"type": "record", "name": "Event", "fields": [{"name": "event/id", "type": "string"}, {"name": "user", "type": {"type": "record", "name": "user_record", "fields": [{"name": "name", "type": "string"}]}}]}',
    ),
    (
        case.SNAKECASE,
        '{"type": "record", "name": "Event", "fields": [{"name": "event_id", "type": "string"}, {"name": "user", "type": {"type": "record", "name": "user_record", "fields": [{"name": "name", "type": "string"}]}}]}',
...
CASE_TO_DATA_COMPLEX_FIELDS_NESTED = [
    (
        case.CAMELCASE,
        '{"type": "record", "name": "UserAdvance", "fields": [{"name": "users", "type": {"type": "array", "items": {"type": "record", "name": "user_record", "fields": [{"name": "name", "type": "string"}]}, "name": "user"}}, {"name": "accounts", "type": {"type": "map", "values": {"type": "record", "name": "account_user_record", "fields": [{"name": "name", "type": "string"}]}, "name": "account"}}]}',
    ),
    (
        case.CAPITALCASE,
        '{"type": "record", "name": "UserAdvance", "fields": [{"name": "Users", "type": {"type": "array", "items": {"type": "record", "name": "user_record", "fields": [{"name": "Name", "type": "string"}]}, "name": "User"}}, {"name": "Accounts", "type": {"type": "map", "values": {"type": "record", "name": "account_user_record", "fields": [{"name": "Name", "type": "string"}]}, "name": "Account"}}]}',
